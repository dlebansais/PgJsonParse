namespace PgJsonObjects
{
    ...
    public class PgAbility
    {
        ...
        public PowerSkill CompatibleSkill { get; set; }
        ...
        public string SelfParticle { get; set; } = string.Empty;
        public PgAbility SharesResetTimerWith { get; set; }
        public PgSkill Skill { get; set; }
        public PgAbilityRequirementCollection CombinedRequirementList { get; set; } = new PgAbilityRequirementCollection();
        ...
        public ConsumedItemCategory ConsumedItems { get; set; }
        ...
        public PgItem ConsumedItemLink { get; set; }
        ...
        public PgItem ConsumedItemDescription { get; set; }
