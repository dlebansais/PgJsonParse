...
public static class MainParser
{
    public static Dictionary<Type, Parser> Parsers { get; } = new Dictionary<Type, Parser>()
    {
        ...
        { typeof(PgAdvancementEffectAttribute), new ParserAdvancementEffect() },
        { typeof(PgAdvancementEffect), new ParserAdvancementEffect() },
        { typeof(PgAdvancementEffectAttributeCollection), new ParserAdvancement() },
        ...
        { typeof(PgLevelCapInteraction), new ParserLevelCapInteractionList() },
        ...
        { typeof(PgReport), new ParserReportList() },
