        ...
        foreach (KeyValuePair<string, object> Entry in contentTable)
        {
            ...
            switch (Key)
            {
                ...
                case "IsSkillReqsDefaults":
                    ...
                    break;
                case "BestowTitle":
                    Result = Inserter<PgPlayerTitle>.SetItemByKey((PgPlayerTitle valuePlayerTitle) => item.BestowTitle_Key = valuePlayerTitle.Key, Value.ToString());
                    break;
                case "BestowLoreBook":
                    Result = Inserter<PgLoreBook>.SetItemByKey((PgLoreBook valueLoreBook) => item.BestowLoreBook_Key = valueLoreBook.Key, Value.ToString());
                    break;
                case "Lint_VendorNpc":
