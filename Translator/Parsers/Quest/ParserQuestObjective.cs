            ...
            else
            {
                ...
                switch (Key)
                {
                    case "Type":
                        break;
                    case "Target":
                        Result = Inserter<PgRecipe>.SetItemByInternalName((PgRecipe valueRecipe) => NewItem.Target_Key = PgObject.GetItemKey(valueRecipe), Value, ErrorControl.IgnoreIfNotFound);
                        if (!Result)
            ...
            else
            {
                ...
                switch (Key)
                {
                    ...
                    case "Target":
                        ...
                        break;
                    case "AnatomyType":
                        Result = Inserter<PgSkill>.SetItemByKey((PgSkill valueSkill) => NewItem.AnatomySkill_Key = PgObject.GetItemKey(valueSkill), $"Anatomy_{Value}");
                        break;
                    case "Description":
                    case "GroupId":
                    case "Number":
            ...
            else
            {
                ...
                switch (Key)
                {
                    case "Type":
                        break;
                    case "Target":
                        Result = Inserter<PgQuest>.SetItemByInternalName((PgQuest valueQuest) => NewItem.TargetQuest_Key = PgObject.GetItemKey(valueQuest), Value);
                        break;
                    case "Description":
                    case "IsHiddenUntilEarlierObjectivesComplete":
                    case "GroupId":
