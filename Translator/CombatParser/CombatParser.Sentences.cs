...
public partial class CombatParser
{
    ...
    private static List<Sentence> SentenceList = new List<Sentence>()
    {
        ...
        new Sentence("Boost the damage of all your attack %f", new List<CombatKeyword>() { CombatKeyword.DamageBoost }),
        //new Sentence("Boost the damage of all your attack by %f", new List<CombatKeyword>() { CombatKeyword.DamageBoost }),
        ...
        new Sentence("Boost the #D damage of @ and @ %f", new List<CombatKeyword>() { CombatKeyword.DamageBoost }),
        ...
        new Sentence("Boost damage %f", CombatKeyword.DamageBoost),
        ...
        //new Sentence("Reduce taunt by %f", CombatKeyword.AddTaunt, SignInterpretation.Opposite),
        ...
        //new Sentence("Taunt of all your attack by %f", CombatKeyword.AddTaunt),
        ...
        new Sentence("When used while stunned", CombatKeyword.WhenUsedWhileStunned),
