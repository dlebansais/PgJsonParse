...
internal partial class CombatParserEx
{
    ...
    private Dictionary<CombatKeywordEx, CombatCondition> KeywordToCondition = new()
    {
        ...
        { CombatKeywordEx.RequireZombieTarget, CombatCondition.ZombieTarget },
        ...
        { CombatKeywordEx.RequireDemonTarget, CombatCondition.DemonTarget },
        { CombatKeywordEx.RequireIncorporealTarget, CombatCondition.IncorporealTarget },
