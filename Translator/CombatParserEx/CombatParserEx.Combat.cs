...
internal partial class CombatParserEx
{
    ...
    private void BuildModEffect(string powerKey, PgEffect effect, string description, bool isGolemMinion, List<AbilityKeyword> abilityList, PgCombatEffectCollectionEx dynamicCombatEffectList, PgCombatEffectCollectionEx staticCombatEffectList, List<AbilityKeyword> targetAbilityList, out PgCombatModEx pgCombatModEx)
    {
        switch (powerKey)
        {
            ...
            case "28613":
            case "3254":
                BuildModEffect_004(description, new PgEffect(), abilityList, new() { dynamicCombatEffectList[0] }, new() { dynamicCombatEffectList[1], staticCombatEffectList[0] }, targetAbilityList, out pgCombatModEx);
                break;
            case "28614":
                BuildModEffect_004(description, new PgEffect(), abilityList, new(), new() { dynamicCombatEffectList[0], staticCombatEffectList[0] }, targetAbilityList, out pgCombatModEx);
                break;
            case "22401":
