...
internal class RawQuest
{
    ...
    public RawQuestRewardItem[]? MidwayGiveItems { get; set; }
    ...
    public RawQuestRewardItem[]? PreGiveItems { get; set; }
    ...
    public RawQuestReward[]? Rewards { get; set; }
    public string[]? Rewards_Effects { get; set; }
    public int? Rewards_Favor { get; set; }
    public RawQuestRewardItem[]? Rewards_Items { get; set; }
