...
namespace PgJsonObjects
{
    public class LoreBookInfoCategory : GenericJsonObject<LoreBookInfoCategory>, IPgLoreBookInfoCategory
    {
        ...
        public virtual string SortingName { get { return ""; } }
        #endregion
        ...
        protected override void SerializeJsonObjectInternal(byte[] data, ref int offset)
        {
            ...
            AddString(SubTitle, data, ref offset, BaseOffset, 4, StoredStringtable);
            AddString(SortTitle, data, ref offset, BaseOffset, 8, StoredStringtable);
