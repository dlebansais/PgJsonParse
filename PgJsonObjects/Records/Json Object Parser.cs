...
namespace PgJsonObjects
{
    ...
    {
        public static void InitAsSubitem(string SubitemName, JObject RawSubarray, out T Subitem, ParseErrorInfo ErrorInfo)
        {
            Subitem = new T();
        ...
        public static void InitAsSublist(JArray RawSubarray, out List<T> Sublist, ParseErrorInfo ErrorInfo)
        {
            Sublist = new List<T>();
