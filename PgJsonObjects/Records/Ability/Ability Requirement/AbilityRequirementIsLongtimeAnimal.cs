...
{
    public class AbilityRequirementIsLongtimeAnimal : AbilityRequirement, IPgAbilityRequirementIsLongtimeAnimal
    {
        ...
        protected override void SerializeJsonObjectInternal(byte[] data, ref int offset)
        {
            ...
            AddInt((int?)OtherRequirementType.IsLongtimeAnimal, data, ref offset, BaseOffset, 0);
