...
{
    public class AbilityRequirementIsHardcore : AbilityRequirement, IPgAbilityRequirementIsHardcore
    {
        ...
        protected override void SerializeJsonObjectInternal(byte[] data, ref int offset)
        {
            ...
            AddInt((int?)OtherRequirementType.IsHardcore, data, ref offset, BaseOffset, 0);
