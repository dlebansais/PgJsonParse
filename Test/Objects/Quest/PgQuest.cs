namespace PgObjects
{
    ...
    public class PgQuest
    {
        ...
        public PgQuestRewardCollection PreGiveItemList { get; } = new PgQuestRewardCollection();
        ...
        public PgQuestRewardCollection QuestMidwayGiveItemList { get; } = new PgQuestRewardCollection();
    }
}
