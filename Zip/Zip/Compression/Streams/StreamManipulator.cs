...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams
{
	...
	public class StreamManipulator
	{
		...
		public int PeekBits(int bitCount)
		{
            ...
            byte[] LongPattern = new byte[8];
            byte[] UIntPattern = BitConverter.GetBytes(buffer_);
            Array.Copy(UIntPattern, 0, LongPattern, 0, 4);
            long l = BitConverter.ToInt64(LongPattern, 0);
            long l2 = ((1 << bitCount) - 1);
            long l3 = l & l2;

            LongPattern = BitConverter.GetBytes(l3);
            int Result = BitConverter.ToInt32(LongPattern, 0);
